...
Current HomeSeer version: **HS4 4.2.8.0**
...
This image was inspired by @marthoc's HomeSeer image (on Docker Hub at marthoc/homeseer), @E1iTeDa357 (github) and @e1ite (docker).  Many thanks!
